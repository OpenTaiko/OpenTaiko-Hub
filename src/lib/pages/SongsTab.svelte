		...
		<thead>
			...
			<tr>
				...
				<th>
					...
					{:else}
					<button type="button" on:click={DownloadDisplayedSongs} class="text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm px-3 py-1 dark:bg-green-600 dark:hover:bg-green-700 button-green">Bulk download</button>
					{/if}
				</th>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<button type="button" on:click={DownloadSong(songInfo, null)} class="text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm px-3 py-1 dark:bg-green-600 dark:hover:bg-green-700 button-green">Download</button>
					{:else}
				...
				<td>
                    ...
                    <br />
                    {#if songDLProgress[songInfo.uniqueId] === undefined}
					<button type="button" on:click={DownloadSong(songInfo, currentSongs[songInfo.uniqueId])} class="text-white bg-gray-700 hover:bg-gray-800 font-medium rounded-lg text-sm px-3 py-1 dark:bg-gray-600 dark:hover:bg-gray-700 button-gray">Redownload</button>
					{:else}
					<ProgressBar bind:value={songDLProgress[songInfo.uniqueId]} max={100} />
					{/if}
				</td>
				...
				<td>
					...
					<br />
					{#if songDLProgress[songInfo.uniqueId] === undefined}
					<button type="button" on:click={DownloadSong(songInfo, currentSongs[songInfo.uniqueId])} class="text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm px-3 py-1 dark:bg-green-600 dark:hover:bg-green-700 button-green">Update</button>
					{:else}
					<ProgressBar bind:value={songDLProgress[songInfo.uniqueId]} max={100} />
					{/if}
				</td>
